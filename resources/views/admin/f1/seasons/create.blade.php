                ...
                <div class="card-body">
                    <form action="{{ route('admin.f1.seasons.store') }}" method="POST">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('completed_races') is-invalid @enderror"
                                           id="completed_races" name="completed_races" value="{{ old('completed_races') }}"
                                           min="0">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('season_image') is-invalid @enderror"
                                           id="season_image" name="season_image" value="{{ old('season_image') }}"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              ...
                                              placeholder="Enter season highlights, notable changes, etc.">{{ old('description') }}</textarea>
                        ...
                        <div class="d-flex justify-content-end gap-2 flex-wrap">
                            <a href="{{ route('admin.f1.seasons.index') }}" class="btn btn-secondary">Cancel</a>
