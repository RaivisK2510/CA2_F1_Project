            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <a href="{{ route('admin.f1.dashboard') }}" class="btn btn-outline-danger">View F1 Dashboard</a>
                        <a href="{{ route('admin.f1.drivers.index') }}" class="btn btn-outline-secondary">Manage Drivers</a>
